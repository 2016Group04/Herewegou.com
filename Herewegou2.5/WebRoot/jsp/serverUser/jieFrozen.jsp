		...
		<div class="categoryMain-list">
			...
			<ul class="item">
				...
				<li class="operation-li">
					<input data-pid="<%=p.getUserId()%>" class="checkbox-input" name="dong" type="checkbox"></input>
				</li>
			</ul>
			<%
				}
		...
		$(function() {
			...
			$(".checkbox-input").change(function(){
				if($(".checkbox-input:checked")[0]==undefined){
						...
						$(".operation-title-li").append("<button id='shelves-btn' class='btn submit-btn' >解 冻</button>");												
				}				
				//点击上架
