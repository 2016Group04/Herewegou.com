											...
											<tbody>
												<tr>
													<td valign="top" class="bodyContent" mc:edit="body_content"
														...
														<h1
															style="text-align:center;margin-left:0;margin-bottom:10px;margin-right:0;margin-top:0;letter-spacing:normal;line-height:100%;font-weight:normal;font-style:normal;font-size:26px;font-family:Micorsoft jHeng Hei;display:block;color:#424F59 !important;">账号已激活</h1>
														<br>恭喜您，账号已激活，请前往登录
													</td>
												</tr>
												<tr width="100%">
