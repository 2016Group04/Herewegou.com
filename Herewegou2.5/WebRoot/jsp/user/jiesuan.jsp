  ...
  <body>
        ...
        %>
    		...
    		<!--<div style="height: 30px;background-color: #F1F1F1;">
    			...
    			<div class="spacer"></div>
    			<div class="div-top2"style="width: 68px; padding: 0px 2px;"><a href="OrderServlet?action=queryOrder">我的订单</a></div>
    			<div class="spacer"></div>
        ...
        <div class="fc-consignee-info">
    	 ...
    	 <div class="tijiao">
        	...
        	<button id="" class="tjbtn"><a  href="#">提交订单</a><b></b></button>
        </div>
        	<!-- 右边悬浮 -->
				<div class="w">
        ...
        <div class="" style="margin-top: 80px;">
			...
			$(function(){
		        		$(".tjbtn").click(function(){
		        			location.assign("OrderServlet?action=tijiao");
		        		});
		        	});
