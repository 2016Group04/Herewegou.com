  ...
  <div class="left-login">
			<div class="login-box">
				...
				<div class="div11">
					...
					<div class="div1">
						<label class="c">收货人</label><input class="c" type="text" name="username" id="username"><br />
					</div>
					<br />

					<div class="div1">
						<label class="c">详细地址</label><input class="c"  type="text" name="address" id="address">
					</div>

					<div class="div1">
						<label class="c">手机号</label><input class="c"  type="text" name="phonenumber" id="phonenumber">
					</div>
					
					<input type="button" class="btn-login" onclick="return checkInput();" value="提交" maxlength="10">
					<!-- 登录按钮 -->
					<!-- <a onclick="submit();" class="loginbutton" >提交					</a> -->				</input>
		...
		<div class="ui-mask" style="position: absolute; left: 0px; top: 0px; opacity: 0.15; z-index: 9998; width: 1349px; height: 1981px; background-color: rgb(0, 0, 0);"></div>
    		...
    		<!--<div style="height: 30px;background-color: #F1F1F1;">
    			...
    			<div class="spacer"></div>
    			<div class="div-top1"><a href="#">关注HWG</a></div>
    			<div class="spacer"></div>
    			<div class="div-top4"><a href="#">手机HWG</a></div>
    			<div class="spacer"></div>
    			<div class="div-top2" style="width: 68px;"><a href="#">企业采购</a></div>
    			<div class="spacer"></div>
    			<div class="div-top1"><a href="#">HWG会员</a></div>
    			<div class="spacer"></div>
    			<div class="div-top1" style="width: 86px;padding: 0px 2px;"><a href="#">我的HWG</a></div>
    			<div class="spacer"></div>
					...
					<li class="fore6 dorpdown" id="ttbar-apps">
						...
						<div class="dd dorpdown-layer" style="height: 187px;">
							...
							<div class="dd-inner" id="ttbar-apps-main">
								...
								<a href="" class="applink jdapp-ios" target="_blank">HWG客户端ios版</a>
								<a href="" class="applink jdapp-android" target="_blank">HWG客户端android版</a>
					...
					<li class="fore7 dorpdown" id="ttbar-atte">
						...
						<div class="dd dorpdown-layer">
							...
							<div class="dd-inner" id="ttbar-atte-main">
								<img src="img/images2/guanzhujderweima.jpg" alt="关注HWG">
							</div>
						</div>
					</li>
					<li class="spacer"></li>
						...
						<div class="dd dorpdown-layer">
							...
							<dl class="fore1"> <dt>特色主题</dt>
								<dd>
									...
									<div class="item">
										<a href="//xinpin.jd.com/presale.html " target="_blank">HWG预售</a>
									</div>
									<div class="item">
										<a href="//zan.jd.com" target="_blank">尖er货</a>
									</div>
									<div class="item">
										<a href="//xinpin.jd.com/new.html" target="_blank">HWG首发</a>
									</div>
									<div class="item">
									...
									<div class="item">
										<a href="//vip.jd.com/" target="_blank">HWG会员</a>
									</div>
									<div class="item">
									...
									<div class="item">
										<a href="//try.jd.com/" target="_blank">HWG试用</a>
									</div>
									<div class="item">
							...
							<dl class="fore2"> <dt>行业频道</dt>
								<dd>
									...
									<div class="item">
										<a href="//smart.jd.com/" target="_blank">HWG智能</a>
									</div>
								</dd>
							</dl>
							<dl class="fore3"> <dt>生活服务</dt>
								<dd>
									<div class="item">
										<a href="//z.jd.com/" target="_blank">HWG众筹</a>
									</div>
									<div class="item">
									...
									<div class="item">
										<a href="//trade.jr.jd.com/myxjk/jrbincome.action" target="_blank">HWG小金库</a>
									</div>
									<div class="item">
									...
									<div class="item">
										<a href="//daojia.jd.com/html/welcome.html" target="_blank">HWG到家</a>
									</div>
									<div class="item">
										<a href="//smartcloud.jd.com/app" target="_blank">HWG微联</a>
									</div>
									<div class="item">
										<a href="//try-smart.jd.com/" target="_blank">HWG众测</a>
									</div>
								</dd>
							</dl>
							<dl class="fore4"> <dt>更多精选</dt>
								<dd>
									<div class="item">
										<a href="http://group.jd.com" target="_blank">HWG社区</a>
									</div>
									<div class="item">
										<a href="//mobile.jd.com/index.do" target="_blank">HWG通信</a>
									</div>
									<div class="item">
										<a href="//read.jd.com/" target="_blank">在线读书</a>
									</div>
									<div class="item">
										<a href="//o.jd.com/market/index.action" target="_blank">HWGE卡</a>
									</div>
									<div class="item">
		...
		<!--最顶上的一条结束-->
    		...
    		<!-- HWG图标 -->
    		<div class="logo">
    			<div class="div1"><a href="//www.jd.com/" class="link1"><img src="img/images2/jd.png" alt="HWG商城"/></a>
                        ...
                        <div class="man_nameandadr">
                        	<div class="man_nameandadr_1">
                        		<div class="man_nameandadr_1_1">
                        			<%=user.getRealName()%><b></b>
                        		</div>
                        		<!--地址-->
                        		<div class="man_nameandadr_1_2">
                        			<span><%=user.getRealName()%></span>
                        			<span title="<%=user.getAddress()%>" class="addr-info" limit="45"><%=user.getAddress()%></span>
                        			<span class="addr-tel"><%-- <%=user.getPhontNum() %> --%></span>
                        		</div>
                        	</div>
                        </div>
                        <!--推荐匹配自提点-->
                    ...
                    <div class="goods">
                       	...
                       	<div class="shopping-list ABTest">
                       			<div class="goods-list">
													    <div class="goods-tit">
													      <h4 class="vendor_name_h" id="0">商家：HWG自营</h4>
													    </div>
					...
					<%
    					...
    					if(list!=null){
	    					...
	    					for(Product product:list){
	    						...
	    						int shoppingCarSum = product.getCountInShoppingCart();
        ...
        <div class="fc-consignee-info">
          ...
          <span id="sendMobile">收货人：<%=user.getRealName()%> <%--电话号码(删掉注释) <%=user.getPhontNum() %> --%></span>
        </div>
    	</div>
    	 <div class="tijiao">
        	
        	<button id="" value="提交订单" class="tjbtn"><a href="tijiaodingdan.html">提交订单</a><b></b></button>
        </div>
        	<!-- 右边悬浮 -->
				<div class="w">
        ...
        <div class="" style="margin-top: 80px;">
			...
			$(function(){
		        	...
		        	function checkInput(){
		        		...
		        		if(username==""||address==""||phoneNum==""){
		        			
		        			$("label.qq").text("请添加收货地址以及收货人姓名、联系方式");
		        			$("label.qq").css("color","red");
		        			return false;
		        			
		        		}else if(!checkPhone(phoneNum)){
		        			
		        			$("label.qq").text("请输入正确的手机号格式");
		        			$("label.qq").css("color","red");
		        			return false;
		        		}else{
		        		
		        			location.assign("OrderServlet?action=checkOrder&username="+username+"&address="+address+"&phonenumber="+phoneNum);
		        		}
