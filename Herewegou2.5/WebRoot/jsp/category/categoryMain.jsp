...
<body>
	...
	<div class="categoryMain-panel">
		...
		<div class="categoryMain-list">
			<ul class="title">
				<li style="width:210px">商品种类编号</li>
				<li style="width:240px">商品种类名称</li>
				<li style="width:270px">商品种类描述</li>
				<li>操作</li>
			</ul>
			...
			%>
			<ul class="item">
				<li class="cid-li" style="width:210px"><%=c.getCid()%></li>
				<li style="width:240px"><%=c.getCname()%></li>
				<li style="width:270px"><%=c.getCdesc()%></li>
		...
		<div class="page-controller">
			<form action="CategoryServlet?action=getAllByPage"></form>
			<%
	...
	<%=pageInfo.getCurrentPage()%>
			...
			$(".search-btn").click(function() {
				assignContent("getPageByCondition", 1);
			});
	...
	<%=pageInfo.getCurrentPage()%>
		== 1) {
				...
				$(".first-page-btn").click(function() {
					assignContent("getAllByPage", 1);
				});

				$(".previous-page-btn").click(
						function() {
							assignContent("getAllByPage",
	...
	<%=pageInfo.getNextPage()%>
		...
		function changePage(currentPage) {
			assignContent("getAllByPage", currentPage);
		}
